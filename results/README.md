...
The `classes.tsv` file contains all the classes that have instances in the input subgraph on music, with their number of instances.
...
- the file `[CLASS]-properties.tsv` contains the list of properties involved in at least one triple, with the number of distinct instances that are subject of at least one triple involving that property
